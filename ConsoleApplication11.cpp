...
private:
    ...
    /**
        ...
        @return норвамальная строка для дальнейшей обработки 
    */
    string parseString() {
        if (json[pos] != '"') return "";
...
public:
   ...
   */
    ...
    */
    ...
    /**
        @breif Парсим массив объектов и извлекаем значения subject_name
...
int main() {
    ...
    string url = "https://msapi.top-academy.ru/api/v2/schedule/operations/get-month?date_filter=2026-02-16";
    vector<string> headers
    { "referer: https://journal.top-academy.ru/" };
    cout << "Введите токен Bearer: ";
    string Bearer;
    cin >> Bearer;
    headers.insert(headers.begin(),(("authorization: Bearer " + Bearer)));
    cout << "Запрос к api..." << url << "..." << endl;
